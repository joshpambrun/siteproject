...
Stonepage.create(title: 'About', content: "Oh no im not good at computer")
Stonepage.create(title: 'Contact', content: "Conact us at example@example.com or phone as at 204-555-1234.")